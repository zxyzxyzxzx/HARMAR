/*
******************************************************************************
** Filename:  main_PINNACLE.c
**
** Description:
**       This is the UAB main program for the PINNACLE system.
...
void uabCommInit( void )
{
    ...
    initData[1] = UAB_PINNACLE_MAJOR_VERSION;
    initData[2] = UAB_PINNACLE_MINOR_VERSION;
    initData[3] = 0;
    uabInfoPageGet(buff);
...
int main(void)
{
    ...
    UabSystemId = UAB_SYSTEM_ID_PINNACLE;
    ...
    */
    ...
    uabInfoPageInit(UabSystemId,
                    UAB_PINNACLE_MAJOR_VERSION,
                    UAB_PINNACLE_MINOR_VERSION);
