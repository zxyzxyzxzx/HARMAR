...
#define CLKOUTCLK_SETUP       1
#define CLKOUTCLKSEL_Val      0x00000003
...
void SystemInit (void)
{
 ...
 /* LPC_SYSCON->CLKOUTDIV = CLKOUTCLKDIV_Val; */
  ...
  LPC_SYSCON->CLKOUTUEN    = 0x01;               /* Update MCLK Clock Source */
  LPC_SYSCON->CLKOUTUEN    = 0x00;               /* Toggle Update Register   */
